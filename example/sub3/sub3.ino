...
const int g_val_spec_min = 1024 * 1/3;   //明るい  0.5K / (0.5K + 1K) = 1/3
const int g_val_spec_max = 1024 * 50/51; //暗い  50K / (50K + 1K) = 50/51

const int g_val_min = 871;  //明るい
const int g_val_max = 941;  //暗い
...
void loop()
{
  int val  = max(analogRead(READ_PIN) - g_val_min, 0);
  ...
  //テンポラリ実装
  //Level 3以上＝暗い ならRUN。
  MSG_CMD msg_cmd = 3<=level? MSG_CMD_RUN: MSG_CMD_STILL;
